...
var tutorial = function() {
    botui.message.add({
        ...
        return botui.action.text({
            ...
            if (res.value == '新垣结衣') {
                girlfriend();
            } else if (res.value == 'wyq') {
                wyq();
            } else if (res.value != '新垣结衣' || 'wyq') {
                return botui.message.add({
                    delay: 1500,
...
var girlfriend = function() {
    botui.message.add({
        delay: 1000,
        content: '让你看看我女朋友,非常漂亮'
    }).then(function() {
        return botui.message.add({
            delay: 1000,
            content: '![新垣结衣](https://img.huihuige.xyz/images/2022/02/12/gakki.jpg)'
        });
    });
}
var wyq = function() {
    botui.message.add({
        delay: 1000,
        content: '打开这个链接看看: https://blog.huihuige.xyz/diguaaixiaran/'
    })
}